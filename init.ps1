...
try {
    ...
    & $mkcert -install
    & $mkcert "*.hublot.localhost"
    & $mkcert "hublot.xmcloudcm.localhost"
...
Add-HostsEntry "hublot.xmcloudcm.localhost"
Add-HostsEntry "www.hublot.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "hublot.xmcloudcm.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.hublot.localhost"
